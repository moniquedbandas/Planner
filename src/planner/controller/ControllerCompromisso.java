...
public class ControllerCompromisso {
    ...
    public boolean cadastraCompromisso(String data, String hora, String descricao) throws Exception{
    ...
    public boolean editarCompromissos(int codCompromisso, String descricao, String data, String hora) throws Exception{
